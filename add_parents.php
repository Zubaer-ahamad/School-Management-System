...
if (isset($_POST['add_student'])) {
    ...
    $check = "SELECT * FROM users WHERE username ='$children_name' ";
    $check_user = $conn->query($check);
    $row_count = mysqli_num_rows($check_user);
    if ($row_count) {
        $Sql = "INSERT INTO users(username, email, usertype, password) VALUES ('$user_name', '$user_email', '$user_type', '$user_password')";
            ...
            <div class="content">
                <center>
                    ...
                    <form action="#" method="post">
                        ...
                        <div>
                            <input type="text" name="children_name" id="children-name-field" placeholder="Your Children Name" class="hero-input">
                        </div>
                        <div>
